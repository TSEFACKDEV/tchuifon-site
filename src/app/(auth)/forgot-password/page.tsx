...
export default function ForgotPasswordPage() {
  ...
  if (sent) {
    return (
      <div className="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 shadow-2xl p-8 text-center">
        ...
        <Link href="/login" className="inline-flex items-center gap-2 text-sm text-blue-200 hover:text-white transition-colors">
  ...
  return (
    <div className="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 shadow-2xl p-8">
      <Link href="/login" className="inline-flex items-center gap-1.5 text-sm text-blue-200 hover:text-white transition-colors mb-6">
        <RiArrowLeftLine className="w-4 h-4" />
        Retour
      </Link>
      <h1 className="text-xl font-semibold text-white mb-1">Mot de passe oublié</h1>
      <p className="text-sm text-blue-200 mb-6">Entrez votre email pour recevoir un lien de réinitialisation.</p>
