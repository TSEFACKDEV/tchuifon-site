  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
      <motion.div initial={{ opacity: 0, y: -16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="mb-10">
        ...
        <p className="text-slate-500">Pour toute demande de collaboration ou d'information</p>
      </motion.div>
      ...
      <div className="grid md:grid-cols-5 gap-8">
        ...
        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.15 }} className="md:col-span-2 space-y-4">
          {[
            { icon: RiMailLine, label: 'Email', value: 'tchuifon@gmail.com', href: 'mailto:tchuifon@gmail.com' },
            { icon: RiPhoneLine, label: 'Téléphone', value: '+237 674 78 00 94', href: 'tel:+237674780094' },
            { icon: RiMapPinLine, label: 'Bureau', value: 'PK 17 Douala, Campus ENSPD', href: null },
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-8">
            {sent ? (
              <div className="text-center py-8">
                ...
                <h3 className="text-lg font-semibold text-slate-900 mb-2">Message envoyé !</h3>
                <p className="text-sm text-slate-500 mb-6">Le Dr Tchuifon vous répondra dans les meilleurs délais.</p>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <input {...register('subject')} placeholder="Demande de collaboration..."
                    className="px-3.5 py-2.5 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent" />
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <textarea {...register('message')} rows={5} placeholder="Décrivez votre demande..."
                ...
                <button type="submit" disabled={isSubmitting}
                  ...
                  {isSubmitting ? 'Envoi en cours...' : (<><RiSendPlaneLine className="w-4 h-4" /> Envoyer le message</>)}
                </button>
              </form>
            )}
          </div>
